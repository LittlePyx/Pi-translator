...
const STYLES = `
  ...
  * { box-sizing:border-box; } button,select { font:inherit; } button { cursor:pointer; }
  ...
  @container (max-width:380px){.result-topline:has(.meta):has(.result-view-controls){display:grid;grid-template-columns:minmax(0,1fr);align-items:start;gap:2px}.result-view-controls{justify-self:end;margin-left:0}}
