...
const STYLES = `
  ...
  * { box-sizing:border-box; } button,select { font:inherit; } button { cursor:pointer; }
  ...
  .sidebar-region-action{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;width:100%;min-height:34px;margin:8px 0 4px;padding:6px 9px;border:1px solid rgba(89,89,223,.32);border-radius:7px;color:#4545c7;background:rgba(89,89,223,.07);text-align:left}.sidebar-region-action:hover{border-color:rgba(89,89,223,.55);background:rgba(89,89,223,.12)}.sidebar-region-icon{width:13px;height:13px;border:1.5px dashed currentColor;border-radius:2px}.sidebar-region-label{font-size:11px;font-weight:760}.sidebar-region-hint{overflow:hidden;color:var(--muted);font-size:9px;font-weight:500;text-overflow:ellipsis;white-space:nowrap}
  ...
  :host([data-pi-theme="dark"]) .sidebar-region-action{color:#c4c8ff;border-color:rgba(160,164,255,.4);background:rgba(99,102,241,.14)}:host([data-pi-theme="dark"]) .sidebar-region-action:hover{border-color:rgba(183,186,255,.62);background:rgba(99,102,241,.22)}
