...
const STYLES = `
  ...
  * { box-sizing:border-box; } button,select { font:inherit; } button { cursor:pointer; }
  ...
  :host([data-pi-theme="dark"]) .document-memory-action.has-review,:host([data-pi-theme="dark"]) .document-review-meta strong{color:#f1d68e}:host([data-pi-theme="dark"]) .document-review-actions .review-resolve{color:var(--muted)}:host([data-pi-theme="dark"]) .correction-undo.is-error,:host([data-pi-theme="dark"]) .segment-correction-status.is-error{color:#ff9aa4}
